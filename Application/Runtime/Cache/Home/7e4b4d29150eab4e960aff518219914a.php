...
<body >
    ...
    <div class="header">
         <a href="javascript:window.history.go(-1);opener.location.reload();"><img src="http://localhost/GKiller/public/images/back.png" border="0" title="返回"></a>                                     
      ...
      <div class="nav">
             <div id="tag">
                ...
                <li  id="school" class="box1_li"><?php echo ($school); ?></li>
                <li id="create" class="box1_li"><?php echo ($create); ?></li>
                <li id="department" class="box1_li"><?php echo ($department); ?></li>
                </ul>
           </div>
     </div> 
